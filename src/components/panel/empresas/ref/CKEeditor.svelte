...
<form action="?/Info" method="post" on:submit|preventDefault={handleSubmit}>
	<button class="btn rounded variant-filled-primary">Guardar</button>
</form>
<main class="relative h-28 w-80 max-w-2xl rounded sm:w-full variant-glass-primary">
	<div id="editor" class=" py-1" />
</main>
